...
exports.start = function(custom_settings, callback) {
    ...
    server = https.createServer({ // Changed from http.createServer to https.createServer
        key: fs.readFileSync('path/to/private/key.pem'), // Add path to your private key
        cert: fs.readFileSync('path/to/certificate.pem') // Add path to your certificate
    }, function(req,resp) {
